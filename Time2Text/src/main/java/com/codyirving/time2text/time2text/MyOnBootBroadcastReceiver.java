...
public class MyOnBootBroadcastReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        while(hasNext){
            ...
            Long longTime = new Long(timeToText);
            if(sendStatus != null && sendStatus.contentEquals("SENT")) {
                ...
                Intent smsSendIntent = new Intent("SMS_SENT").putExtra("ID",String.valueOf(itemId)).setAction("com.codyirving.textola.SMS_SENT");
                Intent smsDeliveredIntent = new Intent("SMS_DELIVERED").putExtra("ID",String.valueOf(itemId)).setAction("com.codyirving.textola.SMS_DELIVERED");
                ...
                alarmIntent.setAction("com.codyirving.textola.ALARM_INTENT");
                ...
                am.setExact(AlarmManager.RTC_WAKEUP, longTime, fireSMS );
            }
